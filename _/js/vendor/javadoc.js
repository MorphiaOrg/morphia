...
( function( global, factory ) {
	...
	if ( "object" === "object" && typeof _$jquery_1.exports === "object" ) {
		...
		_$jquery_1.exports = global.document ?
			factory( global, true ) :
			function( w ) {
				if ( !w.document ) {
...
var _$javadocBundle_2 = {};
;(function () {
  'use strict'
  window.$ = window.jQuery = _$jquery_1
  //jquery-ui does not appear to be compatible with browserify.
  //Therefore we just include the portion used by javadoc here,
  //formatted to pass lint.
  ;(function ($) {
    $.ui = $.ui || {}
