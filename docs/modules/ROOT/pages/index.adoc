...
If you would like to import just the annotations that Morphia uses, you can simply add a new dependency to your project and use the classifer `annotations`.
Using maven that would look like this:
