...
The fields to use in an index definition are defined with the link:javadoc/dev/morphia/annotations/Field.html[`@Field`] annotation.
...
The name used for the field can be either the Java field name or the mapped document field name as defined in the class's mapping via, e.g., the link:javadoc/dev/morphia/annotations/Property.html[`@Property`] or
link:javadoc/dev/morphia/annotations/Embedded.html[`@Embedded`] annotations.
...
*See link:javadoc/dev/morphia/utils/IndexType.html[`@IndexType`]*
...
A collation can be defined using the `collation()` property on link:javadoc/dev/morphia/annotations/IndexOptions.html[`@IndexOptions`] and takes an
link:javadoc/dev/morphia/annotations/Collation.html[`@Collation`] instance.
