...
link:javadoc/dev/morphia/MapReduceOptions.html[MapReduceOptions], and
link:javadoc/dev/morphia/FindAndModifyOptions.html[FindAndModifyOptions] for more information.
