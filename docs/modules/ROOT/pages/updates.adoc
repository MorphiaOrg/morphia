...
xref:javadoc:dev/morphia/query/updates/UpdateOperators.html#[UpdateOperators].
...
In Morphia, this functionality is exposed through the xref:javadoc:dev/morphia/query/Query.html#modify(dev.morphia.query.updates.UpdateOperator, dev.morphia.query.updates.UpdateOperator...)#[Query#modify()]
method.
