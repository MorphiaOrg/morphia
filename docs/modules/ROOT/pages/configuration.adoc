...
For production deployments, consider using the xref:critter-maven.adoc[critter-maven plugin] to generate models at build time and eliminate the startup cost entirely.
