...
@RecipeDescriptor(name = "ArraySlice refactorings", description = "Migrates usages of the ArraySlice constructor to the factory methods.")
public class ArraySliceRefaster {
    ...
    @RecipeDescriptor(name = "ArraySliceLimitAndSkip", description = "Migrates usages of the ArraySlice constructor to the ArraySlice.skip().limit().")
