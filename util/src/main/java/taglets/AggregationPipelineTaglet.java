...
public class AggregationPipelineTaglet extends ManualTaglet {
    ...
    protected String getBaseDocURI() {
        return super.getBaseDocURI() + "reference/operator/aggregation/";
    }
    ...
    protected String genLink(String text) {
        return String.format("<a href='%s%s'>Aggregration Pipeline Stage:  %s</a>", getBaseDocURI(), text.replace("$", ""), text);
    }
