...
<div class="body">
<div class="nav-container" data-component="morphia" data-version="2.2.0-SNAPSHOT">
  <aside class="nav">
    <div class="panels">
...
<div class="nav-panel-explore" data-panel="explore">
  <div class="context">
    ...
    <span class="version">2.2.0-SNAPSHOT</span>
  </div>
  <ul class="components">
    <li class="component">
    ...
    <li class="component is-current">
      ...
      <ul class="versions">
        <li class="version is-current">
          <a href="../index.html">2.2.0-SNAPSHOT</a>
        </li>
        <li class="version is-latest">
...
<div class="page-versions">
  <button class="version-menu-toggle" title="Show other versions of page">2.2.0-SNAPSHOT</button>
  <div class="version-menu">
    <a class="version is-current" href="package-search-index.js">2.2.0-SNAPSHOT</a>
    <a class="version" href="../../2.1.0/javadoc/package-search-index.js">2.1.0</a>
    <a class="version" href="../../2.0.2/javadoc/package-search-index.js">2.0.2</a>
    <a class="version" href="../../1.6.0/javadoc/package-search-index.js">1.6.0</a>
  </div>
</div>
</div>
    <article class="javadoc">
        packageSearchIndex = [{"l":"All Packages","url":"allpackages-index.html"},{"l":"dev.morphia"},{"l":"dev.morphia.aggregation"},{"l":"dev.morphia.aggregation.experimental"},{"l":"dev.morphia.aggregation.experimental.codecs"},{"l":"dev.morphia.aggregation.experimental.codecs.stages"},{"l":"dev.morphia.aggregation.experimental.expressions"},{"l":"dev.morphia.aggregation.experimental.expressions.impls"},{"l":"dev.morphia.aggregation.experimental.stages"},{"l":"dev.morphia.annotations"},{"l":"dev.morphia.annotations.experimental"},{"l":"dev.morphia.experimental"},{"l":"dev.morphia.geo"},{"l":"dev.morphia.mapping"},{"l":"dev.morphia.mapping.codec"},{"l":"dev.morphia.mapping.codec.pojo"},{"l":"dev.morphia.mapping.codec.reader"},{"l":"dev.morphia.mapping.codec.references"},{"l":"dev.morphia.mapping.experimental"},{"l":"dev.morphia.mapping.lazy"},{"l":"dev.morphia.mapping.lazy.proxy"},{"l":"dev.morphia.mapping.validation"},{"l":"dev.morphia.mapping.validation.classrules"},{"l":"dev.morphia.mapping.validation.fieldrules"},{"l":"dev.morphia.query"},{"l":"dev.morphia.query.experimental.filters"},{"l":"dev.morphia.query.experimental.updates"},{"l":"dev.morphia.transactions.experimental"},{"l":"dev.morphia.utils"}]
    </article>
</main>
</div>
<!--
