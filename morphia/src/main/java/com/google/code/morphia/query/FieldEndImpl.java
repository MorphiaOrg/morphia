...
public class FieldEndImpl<T extends CriteriaContainerImpl> implements FieldEnd<T> {
	...
	public T startsWith(String prefix, boolean validate) {
	...
	public T startsWithIgnoreCase(String prefix, boolean validate) {
		Assert.parametersNotNull("prefix",prefix);
	...
	public T endsWith(String suffix, boolean validate) {
	...
	public T endsWithIgnoreCase(String suffix, boolean validate) {
		Assert.parametersNotNull("suffix", suffix);
	...
	public T contains(String string, boolean validate) {
	...
	public T containsIgnoreCase(String string, boolean validate) {
		Assert.parametersNotNull("string", string);
	...
	public T equal(Object val, boolean validate) {
	...
	public T near(int x, int y, boolean validate) {
	...
	public T greaterThan(Object val, boolean validate) {
	...
	public T greaterThanOrEq(Object val, boolean validate) {
		Assert.parametersNotNull("val",val);
	...
	public T hasThisOne(Object val, boolean validate) {
		this.target.add(new FieldCriteria(this.query, this.field, FilterOperator.EQUAL, val, this.validateName, validate));
		return this.target;
	}
	...
	public T hasAllOf(Iterable<?> vals, boolean validate) {
	...
	public T hasAnyOf(Iterable<?> vals, boolean validate) {
		Assert.parametersNotNull("vals",vals);
		Assert.parameterNotEmpty(vals,"vals");
	...
	public T in(Iterable<?> vals, boolean validate) {
		return this.hasAnyOf(vals, validate);
	}
	...
	public T hasThisElement(Object val, boolean validate) {
		Assert.parametersNotNull("val",val);
	...
	public T hasNoneOf(Iterable<?> vals, boolean validate) {
		Assert.parametersNotNull("vals",vals);
		Assert.parameterNotEmpty(vals,"vals");
	...
	public T notIn(Iterable<?> vals, boolean validate) {
		return this.hasNoneOf(vals, validate);
	}
	...
	public T lessThan(Object val, boolean validate) {
		Assert.parametersNotNull("val",val);
	...
	public T lessThanOrEq(Object val, boolean validate) {
		Assert.parametersNotNull("val",val);
	...
	public T notEqual(Object val, boolean validate) {
	...
	public T sizeEq(int val, boolean validate) {
		Assert.parametersNotNull("val",val);
