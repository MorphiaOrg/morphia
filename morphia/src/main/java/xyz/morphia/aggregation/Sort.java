 ...
 * @deprecated Use {@link xyz.morphia.query.Sort} instead.
 */
@Deprecated
public class Sort extends xyz.morphia.query.Sort {
     ...
     * @deprecated Use {@link xyz.morphia.query.Sort#ascending(String)} instead.
     */
    @Deprecated
     ...
     * @param field the field
     * @return the Sort instance
     * @deprecated Use {@link xyz.morphia.query.Sort#descending(String)} instead.
     */
    @Deprecated
     ...
     * @deprecated Use {@link xyz.morphia.query.Sort#getOrder()} instead.
     */
    @Deprecated
