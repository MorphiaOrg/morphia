...
public interface FieldEnd20<T> {
     ...
     */
    Query20<T> contains(String string);
     ...
     * @mongodb.driver.manual reference/operator/query/regex/ $regex
     */
    Query20<T> containsIgnoreCase(String string);
     ...
     */
    Query20<T> elemMatch(Query query);
     ...
     * @mongodb.driver.manual reference/operator/query/regex/ $regex
     */
    Query20<T> endsWith(String suffix);
     ...
     * @mongodb.driver.manual reference/operator/query/regex/ $regex
     */
    Query20<T> endsWithIgnoreCase(String suffix);
     ...
     * @mongodb.driver.manual reference/operator/query/eq/ $eq
     */
    Query20<T> equalIgnoreCase(Object val);
     ...
     */
    Query20<T> greaterThan(Object val);
     ...
     */
    Query20<T> greaterThanOrEq(Object val);
     ...
     */
    Query20<T> hasAllOf(Iterable<?> values);
     ...
     */
    Query20<T> hasAnyOf(Iterable<?> values);
     ...
     */
    Query20<T> hasNoneOf(Iterable<?> values);
     ...
     * @mongodb.driver.manual reference/operator/query/eq/ $eq
     */
    Query20<T> hasThisOne(Object val);
    ...
    default Query20<T> intersects(Geometry geometry) {
     ...
     * @since 2.0
     */
    Query20<T> intersects(com.mongodb.client.model.geojson.Geometry geometry);
     ...
     */
    @Deprecated(since = "2.0", forRemoval = true)
    default Query20<T> intersects(Geometry geometry, final CoordinateReferenceSystem crs) {
     ...
     */
    Query20<T> intersects(com.mongodb.client.model.geojson.Geometry geometry,
                          com.mongodb.client.model.geojson.CoordinateReferenceSystem crs);
     ...
     */
    Query20<T> lessThanOrEq(Object val);
     ...
     */
    Query20<T> mod(long divisor, long remainder);
     ...
     */
    Query20<T> near(double longitude, double latitude);
     ...
     */
    Query20<T> near(double longitude, double latitude, boolean spherical);
     ...
     * @mongodb.driver.manual reference/operator/query/near/ $near
     */
    Query20<T> near(double longitude, double latitude, double radius);
     ...
     * @mongodb.driver.manual reference/operator/query/nearSphere/ $nearSphere
     */
    Query20<T> near(double longitude, double latitude, double radius, boolean spherical);
     ...
     */
    @Deprecated(since = "2.0", forRemoval = true)
    default Query20<T> near(Point point) {
     ...
     * @since 2.0
     */
    Query20<T> near(com.mongodb.client.model.geojson.Point point);
     ...
     */
    @Deprecated(since = "2.0", forRemoval = true)
    default Query20<T> near(Point point, Double maxDistance, Double minDistance) {
     ...
     * @since 2.0
     */
    Query20<T> near(com.mongodb.client.model.geojson.Point point, Double maxDistance, Double minDistance);
     ...
     */
    @Deprecated(since = "2.0", forRemoval = true)
    default Query20<T> nearSphere(Point point) {
     ...
     * @since 2.0
     */
    Query20<T> nearSphere(com.mongodb.client.model.geojson.Point point);
     ...
     */
    @Deprecated(since = "2.0", forRemoval = true)
    default Query20<T> nearSphere(Point point, Double maxDistance, Double minDistance) {
     ...
     * @since 2.0
     */
    Query20<T> nearSphere(com.mongodb.client.model.geojson.Point point, Double maxDistance, Double minDistance);
     ...
     * @mongodb.driver.manual reference/operator/query/nin/ $nin
     */
    Query20<T> notIn(Iterable<?> values);
     ...
     * @mongodb.driver.manual reference/operator/query/regex/ $regex
     */
    Query20<T> startsWith(String prefix);
     ...
     * @mongodb.driver.manual reference/operator/query/regex/ $regex
     */
    Query20<T> startsWithIgnoreCase(String prefix);
     ...
     */
    @Deprecated(since = "2.0", forRemoval = true)
    default Query20<T> within(Polygon boundary) {
     ...
     * @since 2.0
     */
    Query20<T> within(com.mongodb.client.model.geojson.Polygon boundary);
     ...
     */
    @Deprecated(since = "2.0", forRemoval = true)
    default Query20<T> within(MultiPolygon boundaries) {
     ...
     * @since 2.0
     */
    Query20<T> within(com.mongodb.client.model.geojson.MultiPolygon boundaries);
     ...
     */
    @Deprecated(since = "2.0", forRemoval = true)
    default Query20<T> within(Polygon boundary, CoordinateReferenceSystem crs) {
     ...
     * @since 2.0
     */
    Query20<T> within(com.mongodb.client.model.geojson.Polygon boundary, com.mongodb.client.model.geojson.CoordinateReferenceSystem crs);
     ...
     */
    @Deprecated(since = "2.0", forRemoval = true)
    default Query20<T> within(MultiPolygon boundaries, CoordinateReferenceSystem crs) {
