...
public interface ObjectFactory {
     ...
     * {@link org.mongodb.morphia.annotations.Const#CLASS_NAME_FIELDNAME} field in the dbObject passed in.
     * If that field is missing, the given Class is used instead.
     */
     ...
     * Creates an instance of the class defined in the
     * {@link org.mongodb.morphia.annotations.Const#CLASS_NAME_FIELDNAME} field in the dbObject passed in.
     * If that field is missing, morphia attempts to the MappedField to determine which concrete class to instantiate.
     */
