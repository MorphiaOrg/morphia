...
public class Sort {
     ...
     */
    public Sort(final String field, final int order) {
        this.field = field;
        this.order = order;
    }
     ...
     * @return the Sort instance
     */
    public static Sort naturalAscending(final String field) {
     ...
     * @return the Sort instance
     */
    public static Sort naturalDescending(final String field) {
        return new Sort(NATURAL, -1);
    }
