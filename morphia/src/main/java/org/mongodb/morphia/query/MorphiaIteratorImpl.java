 ...
 * @see MorphiaKeyIteratorImpl
 */
public class MorphiaIteratorImpl<T, V> implements MorphiaIterator<T, V> {
     ...
     */
    public MorphiaIteratorImpl(final Datastore datastore, final Iterator<DBObject> it, final Mapper mapper, final Class<T> clazz,
