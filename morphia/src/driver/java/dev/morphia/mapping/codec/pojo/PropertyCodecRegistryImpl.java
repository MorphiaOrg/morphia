...
public class PropertyCodecRegistryImpl implements PropertyCodecRegistry {
    ...
    public PropertyCodecRegistryImpl(final Codec<?> codec, final CodecRegistry codecRegistry,
        ...
        augmentedProviders.add(new FallbackPropertyCodecProvider(codec, codecRegistry));
