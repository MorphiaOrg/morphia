...
public class TestSuperDatastore {
    ...
    public void testGet() throws Exception {
		...
		assertEquals(rect.getCollectionName(), rectLoaded.getCollectionName());
    ...
    public void testFind() throws Exception {
		...
		assertEquals(1, ds.getCount(rect));
		assertTrue(!ns.equals(rect.getCollectionName()));
		...
		assertEquals(rect.getId(), rectLoaded.getId());
		assertEquals(rect.getCollectionName(), rectLoaded.getCollectionName());
		assertEquals(ns, rectLoaded.getCollectionName());
		assertEquals(rect.getArea(), rectLoaded.getArea(), 0);
