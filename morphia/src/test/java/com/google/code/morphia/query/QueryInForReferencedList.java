...
public class QueryInForReferencedList extends TestBase
{
    ...
    private static class HasRefs {
		...
		@Reference ArrayList<ReferencedEntity> refs = new ArrayList<QueryInForReferencedList.ReferencedEntity>();
    }
    ...
    private static class ReferencedEntity extends TestEntity{
		private static final long serialVersionUID = 1L;
		String foo;
		public ReferencedEntity(String s) { foo = s;}
    ...
    public void testInQuery() throws Exception {
    	...
    	List<HasRefs> res = ds.createQuery(HasRefs.class).field("refs").in(hr.refs.subList(1, 3)).asList();
