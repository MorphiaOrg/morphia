...
import static dev.morphia.query.QueryValidator.validateQuery;
...
public class QueryValidatorTest {
    ...
    public void shouldReferToMappedClassInExceptionWhenQueryingPastReferenceField() {
        thrown.expect(ValidationException.class);
        thrown.expectMessage("Cannot use dot-notation past 'reference' in 'dev.morphia.query.QueryValidatorTest$WithReference'");
